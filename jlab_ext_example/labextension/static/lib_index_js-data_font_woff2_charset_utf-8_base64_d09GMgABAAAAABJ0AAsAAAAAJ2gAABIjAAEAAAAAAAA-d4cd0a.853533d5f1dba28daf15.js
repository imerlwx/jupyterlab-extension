...
const ChatComponent = (props) => {
    ...
    const handleSendRef = (0,react__WEBPACK_IMPORTED_MODULE_1__.useRef)(null);
        ...
        (0,_handler__WEBPACK_IMPORTED_MODULE_10__.requestAPI)('segments', {
            ...
            (0,_handler__WEBPACK_IMPORTED_MODULE_10__.requestAPI)('update_seq', {
                ...
                if (userId.startsWith('test_')) {
                    ...
                    setTimeout(() => handleSendRef.current && handleSendRef.current(''), 150);
                }
            })
                .catch(reason => {
...
//# sourceMappingURL=lib_index_js-data_font_woff2_charset_utf-8_base64_d09GMgABAAAAABJ0AAsAAAAAJ2gAABIjAAEAAAAAAAA-d4cd0a.853533d5f1dba28daf15.js.map